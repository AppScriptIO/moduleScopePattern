...
// 📦 Add Nodejs require module resolution path to process.env.NODE_PATH
...
export function addModuleResolutionPath({
...
export function addModuleResolutionPathMultiple({ pathArray = [] }) {
